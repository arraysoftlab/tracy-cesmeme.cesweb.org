...
tag it #CES2015";
$description = "CES is awesome. Memes are awesome. Put them together and you have the ultra-awesome CES Meme Generator. Using proprietary algorithms and decades of data,the CES Meme Generator will automatically create a message you can share on Facebook and other social media to highlight why you’ll be at the 2015 CES. All you have to do is answer a few simple and fun questions.";
...
$title = 'CES MEME Generator';
if(strpos($absolute_url, 'questions')) {
    $title = 'Survey';
} elseif(strpos($absolute_url, 'mymeme')) {
    $title = 'My Meme';
} elseif(strpos($absolute_url, 'viewmeme')) {
    $title = "Start Your Meme";
}

function resolveHasTags($message) {
    if(strpos($message, "#CES2015") === false) {
        $message .= "\n#CES2015";
    }
    return $message;
}